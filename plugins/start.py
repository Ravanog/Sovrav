    ...
    if len(text)>7:
        ...
        if len(argument) == 3:
            ...
            try:
                ...
                return
        temp_msg = await message.reply_sticker("CAACAgIAAxkBAAI5d2V1dOBBBxsXQE90NmXteUw3T_sLAAKrAQACEBptIni-vpHMVGzHHgQ")
        try:
        ...
        for msg in messages:
            ...
            try:
                ...
                await snt_msg.reply_text(
                    f"💢 Files will be deleted in 30 minutes to avoid copyright issues ‼️. Please forward and save them ♻️.",
